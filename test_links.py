...
class LinksTest(unittest.TestCase):
    ...
    def test_links_validos_unlam(self):
        self.assertEqual(
            ...
            'http://www.unlam.edu.ar/index.php?seccion=-1&accion=difusion&idDestacado=8987', 'http://www.unlam.edu.ar/index.php?seccion=-1&accion=difusion&idDestacado=9047', 'http://www.unlam.edu.ar/index.php?seccion=-1&accion=difusion&idDestacado=9056', 'http://www.unlam.edu.ar/index.php?seccion=-1&accion=difusion&idDestacado=9057',
